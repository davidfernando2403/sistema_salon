...
if __name__ == "__main__":
    ...
    with app.app_context():
        ...
        if Servicio.query.count() == 0:
            ...
            servicios = [
                "ACRILICAS","ALISADO DE KERATINA","ALISADO DE KERATINA + CORTE",
                "ALISADO ORGANICO","ALISADO ORGANICO + CORTE","APLICACION DE TINTE",
                "APLICACION DE TINTE + CORTE","RETOQUE DE UÑA + RETIRO","ARREGLO RUBBER",
                "BAÑO DE ACRILICO + DISEÑO","BAÑO DE COLOR","BAÑO DE COLOR + TRATAMIENTO",
                "BAÑO DE COLOR + TRATAMIENTO + CORTE","BIOPLASTIA","BOTOX","BOTOX + CORTE",
                "CELULAS MADRE","CELULAS MADRE COMPLETO","CELULAS MADRE EXPRESS",
                "CELULAS MADRE + CORTE","CELULAS MADRE COMPLETO + CORTE","CEPILLADO",
                "CEPILLADO + CORTE","CORTE DE CERQUILLO","COLOR GEL","COLOR GEL + DISEÑO",
                "COLOR GEL + RETIRO","COLOR GEL OJO DE GATO + RETIRO","COMBO","CORTE",
                "CORTE + BAÑO DE COLOR","CORTE + CELULAS MADRE","CORTE + CEPILLADO",
                "DEFINICION DE RIZOS","DEPILACION CEJA Y BOZO",
                "DEPILACION ROSTRO + HENNA + PLANCHADO","DEPILACION CON PINZA",
                "DEPILACION DE CEJAS","DEPILACION PATILLA Y CEJAS","HENNA",
                "HENNA + DEPILACION","LACEADO DUAL","LACEADO JAPONES","MANICURE GEL",
                "MANICURE LIMPIEZA","MANICURE SIMPLE","MANICURE + PEDICURE",
                "MAQUILLAJE + PESTAÑAS","MAQUILLAJE NATURAL","MECHAS",
                "MECHAS + BIOPLASTIA","MECHAS + BOTOX","MECHAS + CELULAS MADRE EXPRESS",
                "MECHAS + CELULAS MADRE EXPRESS + CORTE","MECHAS + CELULAS MADRE FULL",
                "MECHAS + CELULAS MADRE FULL + CORTE","MECHAS + BIOPLASTIA + CORTE",
                "MECHAS + BOTOX + CORTE","ONDAS","ONDULACION CORTE","PEDICURE",
                "PEDICURE EN GEL","PEDICURE EN GEL + RETIRO","PEDICURE GEL + UÑAS ACRILICAS",
                "PEINADO","PERFILACION DE ROSTRO","PLANCHADO","PLANCHADO DE CEJAS",
                "PLANCHADO DE CEJAS + DEPILACION ROSTRO","PLANCHADO DE CEJAS + HENNA",
                "POLYGEL","RAICES","RAICES + ALISADO ORGANICO","RAICES + BAÑO DE COLOR",
                "RAICES + CORTE","RETIRO + COLOR GEL","RETIRO + MANICURE SIMPLE",
                "RETIRO + PEDICURE SIMPLE","RETIRO + RUBBER","RETIRO ACRILICO",
                "RETIRO DE GEL","RETIRO DE POLIGEL","RETIRO DE RUBBER",
                "RETIRO+COLOR GEL PEDICURE+ UÑA ACRILICA",
                "RETOQUE GEL CONSTRUCTOR + DISEÑO","RETOQUE RUBBER","RUBBER",
                "RUBBER + PEDICURE EN GEL + RETIRO","TINTE","TINTE + TRATAMIENTO","TINTE + CORTE","TIPS + DISEÑO"
            ]

            for s in servicios:
                db.session.add(Servicio(nombre=s))
